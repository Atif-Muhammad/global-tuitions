...
const CourseEnrollment = ({ onClose, course }) => {
  ...
  return (
    <div className=" bg-black">
      <div className="fixed inset-0  backdrop-blur-md font-urbanist  bg-black bg-opacity-50 z-50">
        <ToastContainer />
        ...
        {showModal && selectedRow && (
          <div className="fixed inset-0 bg-gradient-to-br font-urbanist from-black/80 via-gray-900/90 to-black/80 flex items-center justify-center z-50">
            <div

...
const CourseInquiries = () => {
  ...
  useEffect(() => {
    getCourseInq();
    const intervalId = setInterval(getCourseInq, 1000);
  ...
  return (
    <div className="md:w-[80%] w-11/12 bg-black/80 text-white font-urbanist">
      <h2 className="text-5xl bg-gray-800 sticky top-0 text-center font-urbanist py-4">
        Course Inquiries
      </h2>
          ...
          <table className="bg-black/90 border border-gray-600 rounded-lg">
            <thead className="sticky top-20 w-full bg-black">
              <tr className="border-b  text-center border-gray-700">
                ...
                <th className="px-4 w-[14%] py-4 text-gray-300">For Course</th>
                <th className="px-4 w-[10%] py-4 text-gray-300">Date</th>
                <th className="px-2 w-[10%] py-4">Replied</th>
                <th className="px-2 w-[10%] py-4">Viewed</th>
                <th className="px-4 w-[10%] py-4">Actions</th>
              </tr>
            </thead>
            <tbody>
              {inquires.map((inq) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 w-[17%] text-gray-300">
                    {inq.email}
                  </td>
                  {/* <td className="px-4 py-4 w-[40%] text-gray-300">
                    {inq.inquiry}
                  </td> */}
          ...
          >
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                rows="6"
                className="w-full h-32 text-black p-4 border border-gray-400/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition"

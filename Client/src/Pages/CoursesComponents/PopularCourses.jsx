      ...
      {courses.length > 0 && (
        <div>
          ...
          <div className="bg-custombg pb-9 relative">
            ...
            <div className="absolute top-[55%] lg:left-[1.5%] xl:left-[1%]  2xl:left-[4%] md:left-[1%] -translate-y-[50%] z-10">
              <button
            ...
            <div className="absolute top-[55%] lg:right-[1.5%] xl:right-[1%] 2xl:right-[4%]  md:right-[1%] right-0 -translate-y-[50%] z-10">
              <button

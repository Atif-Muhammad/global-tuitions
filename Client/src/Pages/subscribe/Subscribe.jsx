    ...
    <div>
      ...
      <div className="bg-[#A4DCAA] my-5">
        <div className="flex md:flex-row w-full flex-col py-10 text-center justify-center items-center px-14">
          ...
          <div className="md:w-[45%] xl:w-[35%] w-[90%] font-readex">
            <form
              className="flex flex-col items-start gap-5 py-10"
              onSubmit={handleSubmit}
            >
              <div className="md:text-[35px] text-[25px] font-bold">
                <p>GET UPDATES</p>
              </div>
              <div>
                <input
              ...
              <button className="btnbutton py-3 flex justify-center text-sm" type="submit">
